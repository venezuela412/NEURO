...
export function storeTokenBurn(src: TokenBurn) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(2116982796, 32);
        b_0.storeUint(src.queryId, 64);
        b_0.storeCoins(src.amount);
        b_0.storeAddress(src.response_destination);
        b_0.storeBit(src.custom_payload);
    };
}

export function loadTokenBurn(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 2116982796) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _amount = sc_0.loadCoins();
    const _response_destination = sc_0.loadAddress();
    const _custom_payload = sc_0.loadBit();
...
export function loadTupleTokenBurn(source: TupleReader) {
    ...
    const _custom_payload = source.readBoolean();
    return { $$type: 'TokenBurn' as const, queryId: _queryId, amount: _amount, response_destination: _response_destination, custom_payload: _custom_payload };
}
...
export function storeTupleTokenBurn(source: TokenBurn) {
    ...
    builder.writeBoolean(source.custom_payload);
    return builder.build();
}
...
export function loadNeuroVault$Data(slice: Slice) {
    ...
    const _tvl = sc_0.loadCoins();
    return { $$type: 'NeuroVault$Data' as const, owner: _owner, tvl: _tvl };
}

export function loadTupleNeuroVault$Data(source: TupleReader) {
    const _owner = source.readAddress();
    const _tvl = source.readBigNumber();
    return { $$type: 'NeuroVault$Data' as const, owner: _owner, tvl: _tvl };
}
...
export function storeTupleNeuroVault$Data(source: NeuroVault$Data) {
    ...
    builder.writeNumber(source.tvl);
    return builder.build();
}
...
async function NeuroVault_init(owner: Address) {
    const __code = Cell.fromHex('');
...
export const NeuroVault_errors = {
    ...
    34110: { message: "Must deposit more than 0" },
} as const
...
export const NeuroVault_errors_backward = {
    ...
    "Must deposit more than 0": 34110,
} as const
...
const NeuroVault_types: ABIType[] = [
    ...
    {"name":"TokenBurn","header":2116982796,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"response_destination","type":{"kind":"simple","type":"address","optional":false}},{"name":"custom_payload","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"NeuroVault$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"tvl","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
]
