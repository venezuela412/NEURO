...
export function dictValueParserJettonData(): DictionaryValue<JettonData> {
 ...
 type NeuroWallet_init_args = {
    $$type: 'NeuroWallet_init_args';
    master: Address;
    owner: Address;
}

function initNeuroWallet_init_args(src: NeuroWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.master);
        b_0.storeAddress(src.owner);
...
async function NeuroWallet_init(master: Address, owner: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initNeuroWallet_init_args({ $$type: 'NeuroWallet_init_args', master, owner })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const NeuroWallet_errors = {
...
export const NeuroWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const NeuroWallet_types: ABIType[] = [
...
export class NeuroWallet implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = NeuroWallet_errors_backward;
    public static readonly opcodes = NeuroWallet_opcodes;
    
    static async init(master: Address, owner: Address) {
        return await NeuroWallet_init(master, owner);
    }
    
    static async fromInit(master: Address, owner: Address) {
        const __gen_init = await NeuroWallet_init(master, owner);
        const address = contractAddress(0, __gen_init);
        return new NeuroWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new NeuroWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  NeuroWallet_types,
        getters: NeuroWallet_getters,
        receivers: NeuroWallet_receivers,
        errors: NeuroWallet_errors,
    };
